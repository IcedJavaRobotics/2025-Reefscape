...
package frc.robot.stuylib.control.angle;

import frc.robot.stuylib.math.Angle;
import frc.robot.stuylib.streams.angles.filters.AFilter;
import frc.robot.stuylib.streams.numbers.filters.IFilter;
 ...
 *
 * @see frc.robot.stuylib.math.Angle
 * @see frc.robot.stuylib.control.Controller
