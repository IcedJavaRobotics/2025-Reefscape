...
package frc.robot.stuylib.control.angle.feedforward;
...
import frc.robot.stuylib.util.AngleVelocity;

/**
 * A positional feedforward controller for angular systems.
 *
 * @see frc.robot.stuylib.control.feedforward.PositionFeedforwardController
